    ...
    <GuestLayout>
        ...
        <div class="flex-1 flex items-center justify-center mt-4">
            <div class="w-full max-w-md">
                ...
                <p class="text-gray-500 mb-4">Continue managing feedback seamlessly.</p>
...
<!--                        <InputLabel>Password</InputLabel>-->
                    ...
                    <div class="mt-4 block flex flex-row justify-end">
...
<!--                        </label>-->
                    ...
                    <div class="relative my-6">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="px-4 bg-white text-gray-400">Or log in with</span>
                        </div>
                    </div>
                ...
                <p class="text-center text-sm text-gray-400 mt-6">
                    No account?
                    <Link :href="route('signup')" class="text-blue-500 font-medium hover:text-blue-600">Create one</Link>
                </p>
            </div>
    </div>
    </GuestLayout>
