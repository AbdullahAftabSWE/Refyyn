...
const submit = () => {
    form.post('/admin/dashboard/changelog', {
        preserveScroll: true,
    })
}
...
onMounted(() => {
    // Editor is initialized in useEditor
})
    ...
    <AdminLayout>
        <div class="flex-1 flex flex-col overflow-hidden">
            <header class="min-h-[90px] flex items-center justify-between px-8 py-6 border-b border-gray-100 flex-shrink-0">
                <div>
                    <h1 class="text-2xl font-semibold text-gray-900">New Changelog</h1>
                </div>
...
<style scoped>
:deep(.ProseMirror) {
    @apply prose prose-gray max-w-none min-h-[400px] p-4;
    outline: none;
}
